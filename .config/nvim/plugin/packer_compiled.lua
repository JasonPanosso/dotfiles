...
_G.packer_plugins = {
  ["ChatGPT.nvim"] = {
    ...
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/ChatGPT.nvim",
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  ["vim-rhubarb"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-rhubarb",
